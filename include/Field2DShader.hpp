...
class Field2DShader: public GL::AbstractShaderProgram
{
public:
	...
	Field2DShader& drawTexture(GL::RectangleTexture& texture, float posX, float posY) {
	...
	Field2DShader& setTransformationProjectionMatrix(const MatrixTypeFor<2, float>& matrix)
	{
